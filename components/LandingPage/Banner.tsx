  ...
  return (
    <div className="grid lg:grid-cols-2 grid-cols-1 content-center items-center h-fit my-20">
      <div className="flex flex-col justify-center text-black md:px-10 lg:order-1 order-2">
        <h1
          className={`md:text-[35px] text-[30px] font-semibold md:leading-[64px]  ${josefin.className}`}
        >
          Peace of mind: Find Nearby Services with Ease!
        </h1>
        ...
        <h1
          className={`md:text-[35px] text-[30px] font-semibold md:leading-[64px]  ${josefin.className}`}
        >
          Empowering Seniors: Your gateway to a life enriched with convenience and care.
        </h1>
