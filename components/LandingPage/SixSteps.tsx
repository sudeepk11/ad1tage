  ...
  return (
    <div className="py-5 pb-20">
      <div className="px-[50px] max-lg:px-4 max-lg:py-10 hotel-suggestion">
        <h2
          className={`text-[40px] text-center text-black max-lg:text-[32px] max-lg:leading-[35px] mb-[30px]`}
        >
          Why ad1tage?
        </h2>
        <p className="text-[18px] font-light text-center">
          Navigating Life&apos;s Next Chapter - Your Gateway to Tailored
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:px-[124px] mt-8">
        {items.map((item, index) => (
          <div
            key={index}
            className="flex flex-col items-center p-4  border-gray-200 rounded-lg"
          >
