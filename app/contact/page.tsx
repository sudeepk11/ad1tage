...
import addQuery from "../../service/queries/addQuery";
    ...
    <div className="grid grid-cols-1 mt-10 lg:grid-cols-3 max-lg:w-11/12 max-lg:mx-auto  gap-10 p-3  md:mt-16 max-lg:px-4 lg:px-[50px] max-md:py-3">
      <div className="col-span-2">
        ...
        <p className="font-medium text-md mb-10">
          Your queries will be addressed within the span of 24 to 48 hours
        </p>
        <FormWrapper
          formClassName="pb-16"
          buttonWrapperClassName="col-span-2 w-full flex flex-col items-end mt-8"
          buttonClassName="text-white py-3"
          callback={addQuery}
        >
          <ContactForm />
        </FormWrapper>
            ...
            <div className="w-full">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <p className="text-base leading-relaxed mb-9 text-body-color">
                  For any concerns related to listing or discovering services,
                  you can reach out to our team of experts for assistance.
                </p>
